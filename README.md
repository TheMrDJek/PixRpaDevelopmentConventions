...
<details>
    <summary><b>Несколько вариантов для одного термина</b></summary>
...
Если комментарии необходимы, стоит задуматься об чистоте скрипта
...
- Если скрипт часто вызывается, замените его на контейнер
