...
Избегайте повторной обаботки коллекции
...
Избегайте использования Count для проверки на пустоту
...
Проекционная оптимизация (Select)
