...
Избегайте повторной обаботки коллекции<br>
...
Избегайте использования Count для проверки на пустоту<br>
...
Параллельное выполнение (PLINQ)<br>
...
Проекционная оптимизация (Select)<br>
