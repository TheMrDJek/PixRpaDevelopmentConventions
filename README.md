...
- [Рекомендации об наименовании](#Рекомендации-для-наименования)
- [Рекомендации написание скриптов](#рекомендации-для-написание-скриптов)
...
## Рекомендации для написание скриптов
<details>
